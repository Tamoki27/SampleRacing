...
public class CarController : MonoBehaviour 
{
    ...
    FindClosestWaypoint fcw;
    //float accurateWaypoint = 1.0f;
    ...
    void Start()
    {
        ...
        //targetWaypoint = GetComponentsInChildren<Transform>();
    }
    ...
    void GetWaypoints()
    {
        /*if(Vector3.Distance(waypoints[currentWaypoint].transform.position, transform.position) > 1)
        {
            ...
            transform.position = Vector3.MoveTowards(transform.position, waypoints[currentWaypoint].transform.position, Time.deltaTime * currentSpeed);
        }*/
