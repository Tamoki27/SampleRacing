...
public class RivalCarController : MonoBehaviour {
   ...
   // public Texture2D reverseLightTex;
    ...
    void FixedUpdate()
    {
        //target = GameObject.FindGameObjectWithTag("CarAI");
    ...
    {
        //Score Text
        rivalScoretxt.text = "Rival: " + GetRivalScore().ToString();
    ...
    private void OnCollisionEnter(Collision col)
    {
        ...
        {
            //Destroys objects upon collision by checking its magnitude
    ...
    //Setter
    public void SetRivalScore(int sRivalScore)
    {
        rivalScore = sRivalScore;
    }    
